"""
Модуль `currency` содержит схемы данных, используемые в API для работы с
валютами. Эти схемы описывают структуру данных при запросах к API, а также возможные ошибки, которые могут возникать
